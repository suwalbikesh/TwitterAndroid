...
public class DashboardActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        final CircleImageView DashboardProfileImage;
        final TextView txtDashboardUsername;
        getMenuInflater().inflate(R.menu.dashboard, menu);

        DashboardProfileImage = findViewById(R.id.DashboardProfileImage);
        txtDashboardUsername = findViewById(R.id.txtDashboardUsername);

        UsersAPI usersAPI = Base_url.getInstance().create(UsersAPI.class);
        Call<User> userCall = usersAPI.getUserDetails(Base_url.token);
        ...
        userCall.enqueue(new Callback<User>() {
            ...
            public void onResponse(Call<User> call, Response<User> response) {
                ...
                String imgPath = Base_url.imagePath + response.body().getImage();
                String username = response.body().getUsername();

                Picasso.get().load(imgPath).into(DashboardProfileImage);
